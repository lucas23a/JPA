...
public class LibroJpaController implements Serializable {
    ...
    public Libro buscarPorTitulo (String titulo){
        ...
        Libro book;
        try {
            book= (Libro) em.createQuery("SELECT l FROM Libro l WHERE l.titulo LIKE :titulo")
    ...
    public Libro buscarPorAurtor(String autor){
        EntityManager em = getEntityManager();
        Libro book;
        try {
            book= (Libro) em.createQuery("SELECT l FROM Libro l JOIN l.autor a WHERE a.nombre LIKE :autor ")
    ...
    public Libro buscarPorEditorial (String editorial){
        ...
        Libro book;
        try {
            book= (Libro) em.createQuery("SELECT l FROM Libro l JOIN l.editorial e WHERE e.nombre LIKE :editorial ")
